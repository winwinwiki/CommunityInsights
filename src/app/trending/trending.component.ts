import { Component, ViewChild, OnInit, ElementRef, Renderer2, OnChanges, OnDestroy } from '@angular/core';
...
export class TrendingComponent implements OnInit, OnDestroy {
  ...
  constructor(private data: DataTransferService, element: ElementRef, private renderer: Renderer2, private apollo: Apollo) {

...
export class ChartComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscription = combineLatest(this.data.share, this.data.locationshare, this.data.sharedData).subscribe(([text, location, selectedData]) =>{
      if(this.changedObjtext!= text || this.changedObjLocation!=location[0] || this.changeObjselectedData!=selectedData ){
        ...
        this.selectedData = selectedData.split(' ');
  ...
  getTopicsChart() {
    ...
    .subscribe(
      ({ data, loading }) => {
        ...
        document.getElementById("chart") ? this.plotChart(this.topicsChart) : '';
      },error => {
  ...
  getHashtagsChart (){
    ...
    .subscribe(
      ({ data, loading }) => {
        ...
        document.getElementById("chart") ? this.plotChart(this.hashtagChart) : '';
      },error => {
        console.log("error is: ", error);
      }
    )

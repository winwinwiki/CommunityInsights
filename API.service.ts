...
export class APIService {
  ...
  async ListImpactTree(
    start: string,
    end: string,
    region: string,
    parent: string
  ): Promise<Array<ListImpactTreeQuery>> {
    const statement = `query ListImpactTree($start: String!, $end: String!, $region: String!, $parent: String!) {
  ...
  async ListTrendingHashtags(
    ...
    const statement = `query ListTrendingHashtags($start: String!, $end: String!, $region: String!, $parent: String!) {
  ...
  async ListTrendingTopicsMaster(
    ...
    const statement = `query ListTrendingTopicsMaster($start: String!, $end: String!, $region: String!, $parent: String!) {
  ...
  async DiscourseTrendingTopics(
    ...
    const statement = `query DiscourseTrendingTopics($start: String!, $end: String!, $region: String!, $topic: String!, $parent: String!) {
        discourseTrendingTopics(start: $start, end: $end, region: $region, topic: $topic, parent: $parent) {
          __typename
          counts
          sentiment
          topic
  ...
  async HashtagMaster(
    ...
    const statement = `query HashtagMaster($start: String!, $end: String!, $region: String!, $topic: String!, $parent: String!) {
        hashtagMaster(start: $start, end: $end, region: $region, topic: $topic, parent: $parent) {
          __typename
          counts
          sentiment
          topic
  ...
  async ListDiscourseData(
    ...
    const statement = `query ListDiscourseData($start: String!, $end: String!, $region: String!, $parent: String) {
    ...
    if (parent) {
      gqlAPIServiceArguments.parent = parent;
    }
    const response = (await API.graphql(
      graphqlOperation(statement, gqlAPIServiceArguments)
    )) as any;
  ...
  async ListImpactSpi(
    ...
    region: string,
    parent?: string
  ): Promise<Array<ListImpactSpiQuery>> {
    const statement = `query ListImpactSpi($start: String!, $end: String!, $region: String!, $parent: String) {
  ...
  async ListImpactTsf(
    ...
    region: string,
    parent?: string
  ): Promise<Array<ListImpactTsfQuery>> {
    const statement = `query ListImpactTsf($start: String!, $end: String!, $region: String!, $parent: String) {
  ...
  async ListImpactSgd(
    ...
    region: string,
    parent?: string
  ): Promise<Array<ListImpactSgdQuery>> {
    const statement = `query ListImpactSgd($start: String!, $end: String!, $region: String!, $parent: String) {
  ...
  async Location(): Promise<Array<LocationQuery>> {
    const statement = `query Location {
        location {
          __typename
          location
        }
    ...
    const response = (await API.graphql(graphqlOperation(statement))) as any;
    return <Array<LocationQuery>>response.data.location;
  }
